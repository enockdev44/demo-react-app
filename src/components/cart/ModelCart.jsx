import { IoSearchOutline, IoCartOutline, IoHeartOutline, IoCloseOutline } from "react-icons/io5";
import {
  Badges,
				...
				<div className="flex items-center gap-5">
					<div className="images w-20 h-20">
						{cover?.slice(0, 1).map((images, i) => {
							return <img src={images?.image} alt="" key={i} className="w-full h-full object-cover" />
						})}
					</div>
					<div className="deatils w-1/2">
						<BodyOne>{name? name: " "}</BodyOne>
