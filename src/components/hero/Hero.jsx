...
import { Title, BodyOne, Caption } from "../common/CustomComponents";
...
const SampleNextArrow = (props) => {
  ...
  return (
    <div
      className="absolute bottom-0 left-96 lg:left-1/2 slider-btn z-10"
      onClick={onClick}
    >
...
export const Hero = () => {
  ...
  return (
    <div>
      <section className="h-[50vh] lg:h-[90vh] bg-white-100 relative z-1">
        <Slider {...settings}>
          {herolist.map((item) => {
            return (
              <HeroItem
    ...
    <>
      <div className="w-full h-full relative">
        ...
        <div
          ...
          } ${className && classSecond ? "left-0 lg:left-40 top-0 w-96" : ""}`}
        >
          <div>
          ...
          <div className="w-1/2 mt-5">
            <button className="secondary-btn flex justify-end">show now</button>
          </div>
        </div>
      </div>
    </>
